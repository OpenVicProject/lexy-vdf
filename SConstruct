...
opts.Add(BoolVariable(key="build_lvdf_library", help="Build the lexy vdf library.", default=env.get("build_lvdf_library", not is_standalone)))
opts.Add(
    EnumVariable(
        key="precision",
...
opts.Add(BoolVariable("build_lvdf_headless", "Build the lexy vdf headless executable", is_standalone))
